...
<html>
    ...
    <body>
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-text navbar-right hidden-xs" style="color: white;padding-right: 10px" href="../admin/halaman_admin.php">KEMBALI</a>   
  ...
  ?>
              <table id="mahasiswa" class="table table-striped table-bordered" >
                ...
                <tbody>
                    ...
                    $conn = koneksi();                   
                    $sql ="SELECT distinct m.nim,p.nilaiK,p.hasil,m.status FROM prediksi p inner join mahasiswa m on  p.nim = m.nim where status = 'BL'";
                    ...
                    <tr align='left'>
                        ...
                        <?php if($r['hasil'] == 'LC') {$pred = 'Lulus Cepat'; }
							  else if ($r['hasil'] == 'LT' ){$pred = 'Lulus Tepat waktu'; }
